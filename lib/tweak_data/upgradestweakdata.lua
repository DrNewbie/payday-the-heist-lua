...
function UpgradesTweakData:init()
	...
	self.tree_caps = {}
	do
		local (for generator), (for state), (for control) = ipairs(self.itree_caps)
		do
			do break end
...
function UpgradesTweakData:_player_definitions()
	...
	do
		local (for generator), (for state), (for control) = ipairs(self.values.player.body_armor)
		do
			do break end
...
function UpgradesTweakData:_trip_mine_definitions()
	...
	do
		local (for generator), (for state), (for control) = ipairs(self.values.trip_mine.quantity)
		do
			do break end
	...
	local (for generator), (for state), (for control) = ipairs(self.values.trip_mine.damage_multiplier)
	do
		do break end
...
function UpgradesTweakData:_revive_kit_definitions()
	...
	local (for generator), (for state), (for control) = ipairs(self.values.extra_revive_kit.quantity)
	do
		do break end
...
function UpgradesTweakData:_sentry_gun_definitions()
	...
	do
		local (for generator), (for state), (for control) = ipairs(self.values.sentry_gun.ammo_increase)
		do
			do break end
	...
	local (for generator), (for state), (for control) = ipairs(self.values.sentry_gun.armor_increase)
	do
		do break end
...
function UpgradesTweakData:_hk21_definitions()
	...
	do
		local (for generator), (for state), (for control) = ipairs(self.values.hk21.clip_ammo_increase)
		do
			do break end
	...
	do
		local (for generator), (for state), (for control) = ipairs(self.values.hk21.recoil_multiplier)
		do
			do break end
	...
	local (for generator), (for state), (for control) = ipairs(self.values.hk21.damage_multiplier)
	do
		do break end
