...
function NavigationManager:_draw_anim_nav_links()
	...
	do
		...
		if room.nav_links then
			local (for generator), (for state), (for control) = ipairs(room.nav_links)
			do
				do break end
...
function NavigationManager:_commence_coarce_searches(t)
	...
	do
		local (for generator), (for state), (for control) = pairs(self._coarse_searches)
		do
			do break end
	...
	if terminated_searches then
		local (for generator), (for state), (for control) = ipairs(terminated_searches)
		do
			do break end
